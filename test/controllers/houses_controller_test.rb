...
class HousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create house" do
    assert_difference('House.count') do
      post houses_url, params: { house: { banner_url: @house.banner_url, name: @house.name } }
    end
  ...
  test "should update house" do
    patch house_url(@house), params: { house: { banner_url: @house.banner_url, name: @house.name } }
